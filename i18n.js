const translations = {
  ...
  ar: {
    ...
    how: {
      ...
      step3_t: "السائقون يمسحون على أرض المدرج", step3_d: "تُمسح كل عربة عند الاستلام ومرة أخرى عند الطائرة، من الهاتف مباشرة.",
    ...
    cap: {
      ...
      card2_num: "محطات متعددة", card2_t: "حساب واحد، وكل محطة", card2_d: "أدر كل مطار يغطيه فريقك من لوحة جدولة واحدة — دون حسابات دخول منفصلة، ودون جدول بيانات لكل محطة.",
  ...
  zh: {
    ...
    how: {
      ...
      step3_t: "司机在停机坪扫码", step3_d: "每台餐车在取餐时扫码一次,送达飞机时再扫码一次,全程用手机完成。",
    ...
    cap: {
      ...
      card2_num: "多站点管理", card2_t: "一个账户,管理每个站点", card2_d: "在同一块调度看板上管理团队负责的所有机场——无需为每个站点单独登录,也无需各自维护表格。",
